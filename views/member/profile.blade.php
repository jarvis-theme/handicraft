		...
		<div class="nine columns section">
			{{Form::open(array('url'=>'member/update','method'=>'put','class'=>'form-horizontal'))}}
				<div class="field row">
				    ...
				    <input class="five columns text input" id="inputName" type="text" value='{{$user->nama}}' name="nama" placeholder="Name" required />
				</div>            
				<div class="field row">
				    <label class="mheight" for="email"><strong>Email</strong></label>
					<input type="email" class="five columns text input" name='email' value='{{$user->email}}' required id="inputEmail1" placeholder="Email">
				</div>
				<div class="field row">
				    <label class="mheight"><strong>Telepon</strong></label>
					<input type="text" class="five columns text input" id="inputPhone" name='telp' value='{{$user->telp}}' required placeholder="Phone">
				</div>
				<div class="field row">
